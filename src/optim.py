...
parser.add_argument("--train_file", type=str, default='datasets/msmarco_train_valid.json')
...
parser.add_argument("--supervised_ratio", type=float, default=0.8,
                    help='Ratio of train questions used for supervised learning.')
parser.add_argument("--supervised_steps", type=int, default=200, help='Supervised train steps.')
